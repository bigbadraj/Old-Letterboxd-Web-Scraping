...
class LetterboxdScraper:
    ...
    def save_results(self, genre):
        ...
        # Save rejected data
        rejected_path = os.path.join(BASE_DIR, f'rejected_movies.csv')
    ...
    def save_statistics(self, genre):
        ...
        stats_path = os.path.join(BASE_DIR, f'{genre}_filtered_titles_stats.txt')  # Use genre in filename
        ...
        print(f"Top 10 statistics saved to {genre}_filtered_titles_stats.txt")  # Update print statement

def main():
    genres = ["action", "adventure", "animation", "comedy", "crime", "drama", "family", "fantasy", "history", "music", "mystery", "romance", "science-fiction", "thriller", "war", "western"]  # List of genres to iterate through
