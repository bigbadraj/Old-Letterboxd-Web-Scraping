            ...
            if film_title:
                ...
                if rating_count >= MIN_RATING_COUNT:
                    ...
                    if (len(film_titles) % 1) == 0:
                        ...
                        print(f"{'Elapsed Time: ' + format_time(stats['elapsed_time']) + ' | Estimated Time Remaining: ' + format_time(stats['time_remaining']):^100}")
                        print(f"{'Processing Speed: {:.2f} movies/second'.format(stats['movies_per_second']):^100}")
                        print(f"Last Scraped: {film_title} ({release_year})")
...
if film_titles:
    print(f'{len(film_titles)} Film titles were scraped successfully:')
else:
    print("No film titles were scraped.")
...
print("Film titles have been successfully saved to film_titles.csv.")