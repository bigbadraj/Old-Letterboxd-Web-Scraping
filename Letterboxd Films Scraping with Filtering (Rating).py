...
class LetterboxdScraper:
    ...
    def save_statistics(self):
        ...
        stats_path = os.path.join(BASE_DIR, 'rating_filtered_titles_stats.txt')
        with open(stats_path, mode='w', encoding='utf-8') as file:
            file.write("<strong>The Top 2,500 Highest Rated Narrative Feature Films on Letterboxd.</strong>\n\n")
        ...
        print("Top 10 statistics saved to rating_filtered_titles_stats.txt")
